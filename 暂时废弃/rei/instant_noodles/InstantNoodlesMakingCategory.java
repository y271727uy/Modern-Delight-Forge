...
public class InstantNoodlesMakingCategory implements DisplayCategory<InstantNoodlesMakingDisplay> {
    ...
    public static final String TITLE = "emi.category.moderndelight.instant_noodles_making";
    public static final CategoryIdentifier<InstantNoodlesMakingDisplay> INSTANT_NOODLES_MAKING = CategoryIdentifier.of(ModernDelightMain.MOD_ID, "instant_noodles_making");
    ...
    public Renderer getIcon() {
        return EntryStacks.of(ModItems.COOKED_PORTABLE_POT);
    }
    ...
    public List<Widget> setupDisplay(InstantNoodlesMakingDisplay display, Rectangle bounds) {
        ...
        widgets.add(Widgets.createSlot(new Point(startPoint.x + 12, startPoint.y + 7))
                .entry(EntryStacks.of(ModItems.MULTIFUNCTIONAL_WRAPPING_PAPER)));
        ...
        widgets.add(Widgets.createTooltip(new Rectangle(startPoint.x + 47, startPoint.y + 6, 18, 18), Component.translatable(TextUtil.ANYTHING)));
