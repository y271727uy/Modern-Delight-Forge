package com.y271727uy.moderndelight.compat.rei;

import com.y271727uy.moderndelight.block.ModBlocks;
import com.y271727uy.moderndelight.compat.rei.assembly.AssemblyCategory;
import com.y271727uy.moderndelight.compat.rei.assembly.AssemblyDisplay;
import com.y271727uy.moderndelight.compat.rei.baking_tray.BakingTrayCategory;
import com.y271727uy.moderndelight.compat.rei.baking_tray.BakingTrayDisplay;
import com.y271727uy.moderndelight.compat.rei.biogas_fermentation.BiogasFermentationCategory;
import com.y271727uy.moderndelight.compat.rei.biogas_fermentation.BiogasFermentationDisplay;
import com.y271727uy.moderndelight.compat.rei.cuisine.CuisineCategory;
import com.y271727uy.moderndelight.compat.rei.cuisine.CuisineDisplay;
import com.y271727uy.moderndelight.compat.rei.deep_frying.DeepFryingCategory;
import com.y271727uy.moderndelight.compat.rei.deep_frying.DeepFryingDisplay;
import com.y271727uy.moderndelight.compat.rei.freezer.FreezerFreezingCategory;
import com.y271727uy.moderndelight.compat.rei.freezer.FreezerFreezingDisplay;
import com.y271727uy.moderndelight.compat.rei.glass_bowl.GlassBowlMixWithWaterCategory;
import com.y271727uy.moderndelight.compat.rei.glass_bowl.GlassBowlMixWithWaterDisplay;
import com.y271727uy.moderndelight.compat.rei.glass_bowl.GlassBowlWhiskingCategory;
import com.y271727uy.moderndelight.compat.rei.glass_bowl.GlassBowlWhiskingDisplay;
import com.y271727uy.moderndelight.compat.rei.grinding.GrindingCategory;
import com.y271727uy.moderndelight.compat.rei.grinding.GrindingDisplay;
import com.y271727uy.moderndelight.compat.rei.ice_cream_making.IceCreamMakingCategory;
import com.y271727uy.moderndelight.compat.rei.ice_cream_making.IceCreamMakingDisplay;
import com.y271727uy.moderndelight.compat.rei.instant_noodles.InstantNoodlesMakingCategory;
import com.y271727uy.moderndelight.compat.rei.instant_noodles.InstantNoodlesMakingDisplay;
import com.y271727uy.moderndelight.compat.rei.juice_extracting.JuiceExtractingCategory;
import com.y271727uy.moderndelight.compat.rei.juice_extracting.JuiceExtractingDisplay;
import com.y271727uy.moderndelight.compat.rei.oven.OvenBakingCategory;
import com.y271727uy.moderndelight.compat.rei.oven.OvenBakingDisplay;
import com.y271727uy.moderndelight.compat.rei.pizza.PizzaMakingCategory;
import com.y271727uy.moderndelight.compat.rei.pizza.PizzaMakingDisplay;
import com.y271727uy.moderndelight.compat.rei.steaming.SteamingCategory;
import com.y271727uy.moderndelight.compat.rei.steaming.SteamingDisplay;
import com.y271727uy.moderndelight.compat.rei.steaming.SteamingElectricCategory;
import com.y271727uy.moderndelight.compat.rei.steaming.SteamingElectricDisplay;
import com.y271727uy.moderndelight.compat.rei.transform.AdvanceFurnaceTransformCategory;
import com.y271727uy.moderndelight.compat.rei.transform.AdvanceFurnaceTransformDisplay;
import com.y271727uy.moderndelight.compat.rei.transform.OvenTransformCategory;
import com.y271727uy.moderndelight.compat.rei.transform.OvenTransformDisplay;
import com.y271727uy.moderndelight.compat.rei.wooden_basin.WoodenBasinCategory;
import com.y271727uy.moderndelight.compat.rei.wooden_basin.WoodenBasinDisplay;
