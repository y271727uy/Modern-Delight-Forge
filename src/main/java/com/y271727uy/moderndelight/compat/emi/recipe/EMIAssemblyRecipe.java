...
public class EMIAssemblyRecipe implements EmiRecipe {
    ...
    public static final EmiStack WORKSTATION = EmiStack.of(ModBlocks.ELECTRICIANS_DESK.get());
    public static final EmiRecipeCategory CATEGORY
            = new EmiRecipeCategory(new ResourceLocation(ModernDelightMain.MOD_ID, "assembly"), WORKSTATION);
    ...
    public EMIAssemblyRecipe(AssemblyRecipe recipe) {
        ...
        inputs.add(EmiIngredient.of(Ingredient.of(Items.PAPER)));
        inputs.add(EmiIngredient.of(Ingredient.of(Items.INK_SAC,Items.GLOW_INK_SAC,Items.BLACK_DYE)));
        this.input = inputs;
    ...
    public void addWidgets(WidgetHolder widgets) {
        ...
        widgets.addSlot(EmiIngredient.of(Ingredient.of(Items.PAPER)), 123, 9);
