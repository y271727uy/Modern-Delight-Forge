...
public class FreezingRecipe implements Recipe<Container> {
    ...
    public FreezingRecipe(ResourceLocation id, NonNullList<Ingredient> ingredients, ItemStack itemStack){
        this.id = id;
    ...
    public ItemStack getToastSymbol() {
        return ModBlocks.FREEZER.get().asItem().getDefaultInstance();
    }
    ...
    public static class Serializer implements RecipeSerializer<FreezingRecipe> {
        ...
        @Override
        public @Nullable FreezingRecipe fromNetwork(ResourceLocation id, FriendlyByteBuf buf) {
