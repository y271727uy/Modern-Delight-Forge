...
public class WindTurbineControllerScreenHandler extends AbstractContainerMenu {
    private final ContainerData propertyDelegate;
    public final WindTurbineControllerBlockEntity blockEntity;
    public WindTurbineControllerScreenHandler(int syncId, Inventory inventory, FriendlyByteBuf buf){
        this(syncId, inventory, inventory.player.level().getBlockEntity(buf.readBlockPos()),
                new SimpleContainerData(3));
    }

    public WindTurbineControllerScreenHandler(int syncId, Inventory playerInventory,
                                              net.minecraft.world.level.block.entity.BlockEntity blockEntity, ContainerData arrayPropertyDelegate){
        super(ModScreenHandlers.WIND_TURBINE_CONTROLLER_SCREEN_HANDLER.get(),syncId);
